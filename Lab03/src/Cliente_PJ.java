...
public class Cliente_PJ extends Cliente{
    ...
    public Cliente_PJ(String nome, String endereco,LinkedList lista_Veiculos_Cliente, String cnpj, LocalDate dataFundacao){
...
//*************************************************************************************************************************8 */
    ...
    public boolean validarCNPJ(String cnpj){ // Função que valida o cnpj do Cliente;
        ...
        // cnpjTeste = removePrimeiroDigito(cnpjTeste);
        // System.out.println("cnpj sem primeiro digito: " + cnpjTeste);
        // System.out.println("Vou acrescentar o digito verificador: " + primeiroDigitoVerif);                              //Remove primeiro digito em preparação para o calculo do segundo digito verificador;
        ...
        // System.out.println("CNPJ com primeiro digito verificador: " + cnpjTeste);
        ...
        // System.out.println("Segundo digito verificador: " + segundoDigitoVerif);

        long digito_Verificador_Completo = primeiroDigitoVerif*10+segundoDigitoVerif;

        // System.out.println("*****digito verificador completo******: " + digito_Verificador_Completo);
    ...
    private long removePrimeiroDigito(long cnpjTeste) {
        long numerao = Long.parseUnsignedLong("100000000000");
        
        cnpjTeste = cnpjTeste%(numerao);
        return cnpjTeste;
    }
